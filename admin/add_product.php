  ...
  ?>
  <link rel="stylesheet" type="text/css" href="dsds.css">
  <?php
    $error=array();
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <form d="myForm" action="add_product.php" method="post">
                    <!-- Product Category -->
                    ...
                    <label for="exampleFormControlSelect1">Enter Product Name &#160;&#160;<span style="color:red">*</span></label>
                        <div class="input-group input-group-merge input-group-alternative">                    
                          ...
                          <input name="name" class="form-control" pattern="([^\s][A-z0-9À-ž\s].{2,})" title="Min 3 alphabetic, OR Can be alpha-numeric combination" placeholder="" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <form role="form">
                        <div class="form-group mb-3">
                          <label for="exampleFormControlSelect1">Enter Monthly Price &#160;&#160;<span style="color:red">*</span></label>
                            <div class="input-group input-group-merge input-group-alternative">                    
                                ...
                                <input name='mon_price' class="form-control" placeholder="ex: 23" pattern="{1,15}" type="number" required>                                
                            </div>  
                        ...
                        <label for="exampleFormControlSelect1">Enter Annual Price  &#160;&#160;<span style="color:red">*</span></label>
                            <div class="input-group input-group-merge input-group-alternative">                    
                              ...
                              <input name='annual_price' class="form-control" placeholder="ex: 23" pattern="{1,15}" type="number" required>
                            </div>
                        ...
                        <label for="exampleFormControlSelect1">SKU  &#160;&#160;<span style="color:red">*</span></label>
                            <div class="input-group input-group-merge input-group-alternative">                    
                              ...
                              <input name='sku' class="form-control" pattern="(/^([#-]*[a-zA-z0-9])+[a-zA-Z0-9#-]+$/)" type="text" required>
                            </div>
                        </div>
                        <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                        <!-- Features -->                    
                          ...
                          <form role="form">
                            <div class="form-group mb-3">
                              <label for="exampleFormControlSelect1">Web Space(in GB) &#160;&#160;<span style="color:red">*</span></label>
                                <div class="input-group input-group-merge input-group-alternative">                    
                                    ...
                                    <input name='webspace' class="form-control" placeholder="" type="number" required>                                
                                </div>  
                            ...
                            <label for="exampleFormControlSelect1">Bandwidth (in GB)  &#160;&#160;<span style="color:red">*</span></label>
                                <div class="input-group input-group-merge input-group-alternative">                    
                                  ...
                                  <input name='bandwidth' class="form-control" placeholder="" type="number" required>
                                </div>
                              <p><small>Enter 0.5 for 512 MB</small></p>
                            </div>
                            <div class="form-group">
                            ...
                            <label for="exampleFormControlSelect1">Language / Technology Support  &#160;&#160;<span style="color:red">*</span></label>
                                <div class="input-group input-group-merge input-group-alternative">                    
                                  ...
                                  <input name='ltsupport' pattern="^([a-zA-Z ,-]+)$" title="Two decimal(.) not allowed together,White spaces no allowed,No special character except @." class="form-control" placeholder="" type="text">
                                </div>
  ...
  <style>    .error{ outline: 2px solid red;  }    </style>
